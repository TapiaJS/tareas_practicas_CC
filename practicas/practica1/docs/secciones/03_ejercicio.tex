...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imagenes/pruebas/ejemplar_si.png}
    \caption{Captura de pantalla de la salida en terminal al ejecutar el algoritmo \texttt{mochila\_pesos\_identicos.py} con el \texttt{ejemplar\_si.txt}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imagenes/pruebas/ejemplar_no.png}
    \caption{Captura de pantalla de la salida en terminal al ejecutar el algoritmo \texttt{mochila\_pesos\_identicos.py} con el \texttt{ejemplar\_si.txt}}
\end{figure}
